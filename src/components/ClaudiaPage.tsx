...
export default function ClaudiaPage() {
  ...
  // IMPORTANTE:
  // El ref ahora apunta a un <span>, no al ícono directamente.
  ...
  const handlePrimaryEnter = () => {
    ...
    // Solo el contenedor del ícono se desplaza hacia la derecha
  ...
  const handlePrimaryLeave = () => {
    ...
    // El contenedor del ícono vuelve a su posición original
    gsap.to(primaryIconRef.current, {
      x: 0,
      color: '#003C43',
      duration: 0.4,
        ...
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="font-noto-sans text-base text-[#181c1d] leading-relaxed max-w-2xl">
              Claudia, idola,Lorem ipsum dolor sit amet consectetur adipisicing
              elit. Rem, maxime. Nostrum repellendus ipsa explicabo, sunt amet
              tempore numquam sed aliquid, laudantium asperiores reiciendis
              facere enim debitis deserunt iure cum nobis? Lorem ipsum dolor sit
              amet consectetur adipisicing elit.
            </p>

            <p className="font-noto-sans text-base text-[#181c1d] leading-relaxed max-w-2xl">
              Frente a la ausencia de espacios equivalentes para pacientes
              hispanohablantes, nació la visión de crear una plataforma propia
              para Argentina y toda la communidad latina. Hoy, tras su
              fallecimiento en febrero de 2026, esta plataforma honra su memoria
              continuando ese propósito: construir una comunidad donde nadie
              enfrente el melanoma en soledad.
            </p>
          </div>
        ...
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              {/* Contenedor del ícono (con ref) */}
              <span
                ref={primaryIconRef}
                className="relative z-10 text-[#003C43] flex items-center"
              >
                <ArrowRight className="w-5 h-5 shrink-0 pt-[1px]" />
              </span>
            </button>
          </div>
        </div>
