        ...
        {data.map((d, index) => (
          ...
          >
            ...
            <div>
              ...
              <span className="text-sm text-[#181c1d]/70 font-noto-sans">
                {d.label}
              </span>
            </div>
          </motion.div>
  ...
  const barData: BarDatum[] = [
    {
      label: 'Estadio I',
      pct: 47,
      color: 'linear-gradient(180deg,#00252a,#003c43)',
    },
    {
      label: 'Estadio II',
      pct: 29,
      color: 'linear-gradient(180deg,#005662,#00252a)',
    },
    {
      label: 'Estadio III',
      pct: 14,
      color: 'linear-gradient(180deg,#aaeaf5,#77d8ec)',
    },
    {
      label: 'Estadio IV',
      pct: 10,
      color: 'linear-gradient(180deg,#d0f5f8,#aaeaf5)',
    },
  ];

  const donutData: DonutDatum[] = [
    {
      label: 'Extensivo superficial',
      pct: 70,
      color: '#003C43',
    },
    {
    ...
    {
      label: 'Lentiginoso acral',
      pct: 10,
      color: '#005662',
    },
    {
      label: 'Lentigo maligno',
      pct: 5,
      color: '#d0f5f8',
    },
  ];
        ...
        <div className="max-w-[1000px] w-full">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center justify-between mb-12 mt-8">
            <div>
              ...
              <p className="text-[#181c1d] text-base font-noto-sans max-w-lg">
                Artículos, datos y fundamentos científicos para comprender el
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-7 hover:shadow-[0_20px_40px_rgba(0,60,67,0.06)] transition-shadow">
              ...
              <p
                className="font-inconsolata text-[0.95rem] font-semibold text-[#003C43] mb-6"
                style={{ letterSpacing: '-0.01em' }}
              >
