...
const contentVariants = {
  open: { height: 'auto', opacity: 1, marginTop: '1.25rem' },
...
function SectionToggle({
  ...
  return (
    <button
      ...
      aria-expanded={open}
      aria-controls={id}
      className="ml-auto shrink-0 p-2 rounded-lg border border-[rgba(0,60,67,0.12)] hover:bg-[#f6fafa] transition-colors"
    >
      <motion.div
      ...
      >
        <ChevronDown className="w-5 h-5 text-[#003C43]/60" />
      </motion.div>
    </button>
  );
}
...
export default function ResourcesPage() {
  ...
  return (
    <div className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3">
              {['Autoexamen mensual', 'Protección UV', 'Consulta dermatológica'].map(
                (item) => (
                  <span
                    key={item}
      ...
      {/* GRID PRINCIPAL */}
    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 items-start">
        {/* ¿QUÉ ES EL MELANOMA? */}
        <article className="bg-white rounded-xl p-7 hover:shadow-[0_20px_40px_rgba(0,60,67,0.07)] transition-shadow">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <h2 className="font-inconsolata text-2xl font-bold text-[#003C43]">
                ¿Qué es el Melanoma?
              </h2>
            </div>
            <SectionToggle id="melanoma-content" open={open.melanoma} onToggle={() => toggle('melanoma')} />
          </div>
                ...
                <div className="flex flex-col gap-6 text-sm text-[#181c1d]/75 leading-relaxed font-noto-sans">
                  ...
                  <div className="border border-[rgba(0,60,67,0.06)] rounded-xl overflow-hidden">
                    ...
                    <div className="divide-y divide-[rgba(0,60,67,0.06)]">
                      {[
                        ['Melanoma de extensión superficial', 'Es el subtipo más frecuente. Crece inicialmente de manera horizontal sobre la piel.', '70%'],
                        ['Melanoma nodular', 'Presenta crecimiento vertical rápido y mayor agresividad clínica.', '15%'],
                        ['Lentigo maligno melanoma', 'Frecuente en adultos mayores y zonas fotoexpuestas crónicas.', '5%'],
                        ['Melanoma lentiginoso acral', 'Aparece en palmas, plantas y debajo de las uñas.', '10%'],
                      ].map(([title, desc, pct]) => (
                        <div key={title} className="flex items-start justify-between gap-5 p-5">
                          <div>
                            <p className="font-inconsolata font-bold text-[#003C43] mb-1">{title}</p>
                            <p className="text-sm text-[#181c1d]/70 leading-relaxed">{desc}</p>
                          </div>
                          <div className="shrink-0">
                            <span className="font-inconsolata text-sm font-bold text-[#003C43]">{pct}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="bg-[#003C43] rounded-xl p-6 text-[#E3FEF7]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-[#E3FEF7]/80 mt-4">
                      {[
                        ...
                        'Piel clara y sensibilidad solar elevada',
        ...
        <article className="bg-white rounded-xl p-7 hover:shadow-[0_20px_40px_rgba(0,60,67,0.07)] transition-shadow">
          <div className="flex items-start justify-between gap-4">
            ...
            <SectionToggle id="stats-content" open={open.stats} onToggle={() => toggle('stats')} />
          </div>
                ...
                <div className="flex flex-col gap-6 text-sm text-[#181c1d]/75 leading-relaxed font-noto-sans">
                  ...
                  <div className="bg-[#f6fafa] rounded-xl p-5 border border-[rgba(0,60,67,0.05)]">
                    ...
                    <div className="flex flex-col gap-4 text-sm text-[#181c1d]/70 leading-relaxed">
                      <p>A nivel global, de acuerdo a la Agencia Internacional para la Investigación del Cáncer (IARC), se diagnosticaron 331.722 nuevos casos de melanoma en 2022.</p>
                      <p>De ese total, 20.117 casos correspondieron a Latinoamérica y más de 1.600 fueron registrados en Argentina.</p>
                      <p>El melanoma en Latinoamérica muestra una incidencia creciente, con más de 20.000 casos anuales reportados.</p>
                      <p>Aproximadamente el 40% de los diagnósticos ocurren antes de los 55 años.</p>
                      <p>Según proyecciones de la Organización Mundial de la Salud (OMS), para 2025 el número de fallecimientos por melanoma podría aumentar un 20%.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      >
                        ...
                        <p className="text-[11px] uppercase tracking-wide text-[#181c1d]/55 leading-snug">{d}</p>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  <div className="bg-[#f6fafa] rounded-xl p-6 border border-[rgba(0,60,67,0.05)]">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <p className="font-inconsolata text-xs font-bold uppercase tracking-wide text-[#003C43] mb-1">Incidencia global</p>
                        <p className="text-sm text-[#181c1d]/60">Crecimiento sostenido de melanoma invasivo</p>
                      </div>
                      <span className="font-inconsolata text-sm font-bold text-[#003C43]">+46.6%</span>
                    </div>
                    <div className="relative h-44">
                      <div className="absolute inset-0 flex flex-col justify-between">
                        {[1, 2, 3, 4].map((i) => (
                          <div key={i} className="border-t border-dashed border-[#003C43]/10" />
                        ))}
                      </div>
                      <svg viewBox="0 0 500 180" className="w-full h-full relative z-10" preserveAspectRatio="none">
                        <motion.path
                    ...
                    <div className="flex justify-between mt-4 text-[11px] uppercase tracking-wide text-[#181c1d]/45">
                      {['2010', '2013', '2016', '2019', '2022'].map((y) => <span key={y}>{y}</span>)}
                    </div>
                  </div>

                  <div className="border border-[rgba(0,60,67,0.06)] rounded-xl overflow-hidden">
                    <div className="bg-[#003C43] px-5 py-3">
                      <p className="font-inconsolata text-sm font-bold uppercase tracking-wide text-[#E3FEF7]">Tendencias epidemiológicas</p>
                    </div>
                    <div className="divide-y divide-[rgba(0,60,67,0.06)]">
                      {[
                        ['Latinoamérica y Argentina', 'El melanoma en Latinoamérica muestra una incidencia creciente, con más de 20.000 casos anuales reportados. En Argentina se registran más de 1.600 nuevos casos por año.'],
                        ['Australia y Nueva Zelanda', 'Presentan las tasas más altas del mundo por radiación UV intensa y población predominantemente caucásica.'],
                        ['Europa y Norteamérica', 'Incremento sostenido de incidencia especialmente en adultos jóvenes y menores de 55 años.'],
                        ['Mortalidad', 'Las proyecciones de la OMS estiman que los fallecimientos por melanoma podrían aumentar un 20% hacia 2025.'],
                      ].map(([title, desc]) => (
                        <div key={title} className="p-5">
                          <p className="font-inconsolata font-bold text-[#003C43] mb-2">{title}</p>
                          <p className="text-sm text-[#181c1d]/70 leading-relaxed">{desc}</p>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="bg-[#003C43] rounded-xl p-6 text-[#E3FEF7]">
                    <p className="font-inconsolata text-sm font-bold uppercase tracking-wide mb-3">Detección temprana</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
          ...
          <article className="bg-white rounded-xl p-7 hover:shadow-[0_20px_40px_rgba(0,60,67,0.07)] transition-shadow">
            <div className="flex items-start justify-between gap-4">
              ...
              <SectionToggle id="abcde-content" open={open.abcde} onToggle={() => toggle('abcde')} />
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {[
                      ...
                      ['B', 'Bordes irregulares', 'Los bordes son desparejos, dentados o poco definidos.'],
                      ['C', 'Color desigual', 'Presencia de varios tonos marrones, negros, rojizos o azulados.'],
                      ['D', 'Diámetro > 6 mm', 'Lesiones mayores a 6 mm deben ser evaluadas.'],
                      ['E', 'Evolución', 'Cambios recientes en tamaño, forma, color o síntomas.'],
                    ].map(([letter, title, desc]) => (
                      <div key={letter} className="border border-[rgba(0,60,67,0.06)] rounded-xl p-5 bg-[#f6fafa] h-full">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="min-w-0">
                            <h3 className="font-inconsolata text-base font-bold text-[#003C43] mb-1 mt-1 leading-tight">{title}</h3>
                            <p className="text-sm text-[#181c1d]/70 leading-relaxed font-noto-sans">{desc}</p>
                          </div>
                        </div>
                      </div>
                    ))}
          ...
          <article className="bg-white rounded-xl p-7 hover:shadow-[0_20px_40px_rgba(0,60,67,0.07)] transition-shadow">
            <div className="flex items-start justify-between gap-4">
              ...
              <SectionToggle id="autoexamen-content" open={open.autoexamen} onToggle={() => toggle('autoexamen')} />
            </div>

            <AnimatePresence initial={false}>
              {open.autoexamen && (
                <motion.div
                  id="autoexamen-content"
                  key="autoexamen"
                  initial="closed"
                  animate="open"
                  exit="closed"
                ...
                >
                  ...
                  <div className="flex flex-col gap-4">
                    {[
                      ['1', 'Rostro y cuero cabelludo', 'Examinar cara, cuello, orejas y cuero cabelludo utilizando espejo de mano o ayuda externa.'],
                      ['2', 'Tronco y extremidades', 'Revisar brazos, torso, espalda, axilas y manos observando cambios de color, forma o tamaño.'],
                      ['3', 'Piernas, pies y uñas', 'Controlar piernas, plantas de los pies, uñas y espacios interdigitales donde también puede aparecer melanoma.'],
                    ].map(([n, title, desc]) => (
                      <div key={title} className="border border-[rgba(0,60,67,0.06)] rounded-xl p-5 bg-[#f6fafa]">
                        <div className="flex items-start gap-4">
                          <div className="w-7 h-7 rounded-full bg-[#003C43] text-white flex items-center justify-center font-inconsolata text-sm font-bold shrink-0">
                            {n}
                          </div>
      ...
      <section className="mb-16 bg-white rounded-2xl p-8 border border-[rgba(0,60,67,0.06)]">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          <SectionToggle id="diagnostico-content" open={open.diagnostico} onToggle={() => toggle('diagnostico')} />
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="flex flex-col gap-6">
                  <div className="bg-[#f6fafa] rounded-xl p-6 border border-[rgba(0,60,67,0.05)]">
                    ...
                    <div className="flex flex-col gap-5 text-sm text-[#181c1d]/70 leading-relaxed">
                      <div>
                        <p className="font-inconsolata font-bold text-[#003C43] mb-2">T (Tumor) · Espesor de Breslow</p>
                        <p>T1: &lt;1.0 mm · T2: 1.01–2.0 mm · T3: 2.01–4.0 mm · T4: &gt;4.0 mm</p>
                        <p className="mt-2">a: sin ulceración · b: con ulceración</p>
                      </div>
                      <div>
                        <p className="font-inconsolata font-bold text-[#003C43] mb-2">N (Nodos) · Ganglios Linfáticos</p>
                        <p>N0: sin metástasis · N1: 1 nodo · N2: 2–3 nodos · N3: 4 o más nodos</p>
                      </div>
                      <div>
                        <p className="font-inconsolata font-bold text-[#003C43] mb-2">M (Metástasis) · Distante</p>
                        <p>M0: sin metástasis · M1: metástasis a distancia</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-[#f6fafa] rounded-xl p-6 border border-[rgba(0,60,67,0.05)]">
                    <h3 className="font-inconsolata text-lg font-bold text-[#003C43] mb-3">Biopsia Excisional</h3>
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <div key={stage} className="border border-[rgba(0,60,67,0.06)] rounded-xl p-5 bg-white">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-inconsolata text-base font-bold text-[#003C43] mb-1 leading-tight">{title}</h3>
                          <p className="text-sm text-[#181c1d]/65 leading-relaxed">{desc}</p>
                        </div>
                      </div>
                    </div>
                  ))}
                  <div className="bg-[#003C43] rounded-xl p-5 text-[#E3FEF7]">
                    <p className="font-inconsolata font-bold mb-2">Biopsia de Ganglio Centinela</p>
      ...
      <section className="mb-16">
        <div className="flex items-start justify-between gap-4 mb-4">
          <div>
            ...
            <h2 className="font-inconsolata text-3xl font-bold text-[#003C43]">
              Inmunoterapia
            </h2>
          </div>
          <SectionToggle id="inmunoterapia-content" open={open.inmunoterapia} onToggle={() => toggle('inmunoterapia')} />
        </div>

        <AnimatePresence initial={false}>
          {open.inmunoterapia && (
            <motion.div
              id="inmunoterapia-content"
              key="inmunoterapia"
              initial="closed"
              animate="open"
              exit="closed"
              ...
              style={{ overflow: 'hidden' }}
            >
              <p className="text-[#181c1d]/70 max-w-3xl leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white rounded-xl p-7 border border-[rgba(0,60,67,0.06)]">
                  ...
                  <h3 className="font-inconsolata text-xl font-bold text-[#003C43] mb-5">Inhibidores de PD-1</h3>
                  <div className="flex flex-col gap-5 text-sm text-[#181c1d]/70 leading-relaxed">
                    <div>
                      <p className="font-inconsolata font-bold text-[#003C43] mb-1">Nivolumab (Opdivo®)</p>
                      <p>Aprobado en 2014. Utilizado tanto en monoterapia como en combinación.</p>
                    </div>
                    <div>
                      <p className="font-inconsolata font-bold text-[#003C43] mb-1">Pembrolizumab (Keytruda®)</p>
                      <p>Aprobado en 2014 como primera línea de tratamiento.</p>
                    </div>
                    <div className="bg-[#f6fafa] rounded-xl p-5 border border-[rgba(0,60,67,0.05)]">
                      <p className="font-inconsolata font-bold text-[#003C43] mb-2">Mecanismo</p>
                      <p>Bloquean PD-1 para liberar los frenos del sistema inmune, permitiendo que las células inmunológicas ataquen al melanoma.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-7 border border-[rgba(0,60,67,0.06)]">
                  ...
                  <h3 className="font-inconsolata text-xl font-bold text-[#003C43] mb-5">Terapias Avanzadas</h3>
                  <div className="flex flex-col gap-5 text-sm text-[#181c1d]/70 leading-relaxed">
                    <div>
                      <p className="font-inconsolata font-bold text-[#003C43] mb-1">Ipilimumab (Yervoy®)</p>
                      <p>Primer inhibidor de checkpoint aprobado (2011). Actualmente usado principalmente en combinación.</p>
                    </div>
                    <div>
                      <p className="font-inconsolata font-bold text-[#003C43] mb-1">Relatlimab + Nivolumab</p>
                      <p>Aprobada en marzo 2022 para melanoma avanzado. Añade un nuevo blanco inmunológico anti-LAG3.</p>
                    </div>
                    <div>
                      <p className="font-inconsolata font-bold text-[#003C43] mb-1">Formulaciones Subcutáneas (2024-2025)</p>
                      <p>Nivolumab y pembrolizumab disponibles en inyección subcutánea (3-5 minutos) versus infusión intravenosa tradicional (30-60 minutos).</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 bg-[#003C43] rounded-2xl p-8 text-[#E3FEF7]">
                <h3 className="font-inconsolata text-2xl font-bold mb-5">Resultados CheckMate 067 · 10 años</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={label} className="bg-white/5 rounded-xl p-5 border border-white/10">
                      <p className="font-inconsolata text-2xl font-bold mb-2 leading-none">{value}</p>
                      <p className="text-sm text-[#E3FEF7]/75">supervivencia global a 10 años · {label}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="mb-16 bg-white rounded-2xl p-8 border border-[rgba(0,60,67,0.06)]">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          <SectionToggle id="terapia-content" open={open.terapia} onToggle={() => toggle('terapia')} />
        </div>
          ...
          {open.terapia && (
            ...
            >
              <div className="flex flex-col gap-8">
                <div className="bg-[#f6fafa] rounded-xl p-6 border border-[rgba(0,60,67,0.05)]">
                  <p className="font-inconsolata text-lg font-bold text-[#003C43] mb-3">Mutación BRAF</p>
                  <p className="text-sm text-[#181c1d]/70 leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="border border-[rgba(0,60,67,0.06)] rounded-xl p-6">
                    <h3 className="font-inconsolata text-lg font-bold text-[#003C43] mb-5">Inhibidores BRAF</h3>
                    <div className="flex flex-col gap-4 text-sm text-[#181c1d]/70">
                      <div>
                        <p className="font-inconsolata font-bold text-[#003C43]">Vemurafenib (Zelboraf®)</p>
                        <p>Primera terapia dirigida aprobada en 2011.</p>
                      </div>
                      <div>
                        <p className="font-inconsolata font-bold text-[#003C43]">Dabrafenib (Tafinlar®)</p>
                        <p>Mayor selectividad y menor toxicidad.</p>
                      </div>
                      <div>
                        <p className="font-inconsolata font-bold text-[#003C43]">Encorafenib (Braftovi®)</p>
                  ...
                  <div className="border border-[rgba(0,60,67,0.06)] rounded-xl p-6">
                    <h3 className="font-inconsolata text-lg font-bold text-[#003C43] mb-5">Inhibidores MEK</h3>
                    <div className="flex flex-col gap-4 text-sm text-[#181c1d]/70">
                      <p>Trametinib (Mekinist®)</p>
                      <p>Cobimetinib (Cotellic®)</p>
                      <p>Binimetinib (Mektovi®)</p>
                      <div className="bg-[#f6fafa] rounded-lg p-4 mt-2">
                        <p>MEK es una enzima que trabaja junto a BRAF. Inhibir MEK ayuda a retrasar la resistencia al tratamiento.</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="bg-[#003C43] rounded-2xl p-10 text-[#E3FEF7] overflow-hidden relative">
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-inconsolata text-3xl font-bold">Prevención</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={item} className="bg-white/5 border border-white/10 rounded-xl p-5 flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed text-[#E3FEF7]/80">{item}</p>
              </div>
            ))}
          </div>
        </div>
